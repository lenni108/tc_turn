...
Java_com_turnskiing_tcturn_ModelManager_registerListenerJNI(JNIEnv *env, jclass type,
                                                          jobject callbacks) {
...
Java_com_turnskiing_tcturn_ModelManager_loadModelAsync(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_turnskiing_tcturn_ModelManager_runModelAsync(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_turnskiing_tcturn_ModelManager_unloadModelAsync(JNIEnv *env, jclass type) {
    if (NULL == modelManager) {
        LOGE("please load model first");
