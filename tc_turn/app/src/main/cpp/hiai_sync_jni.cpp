...
Java_com_turnskiing_tcturn_ModelManager_loadModelSync(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_turnskiing_tcturn_ModelManager_unloadModelSync(JNIEnv *env, jclass type) {
...
Java_com_turnskiing_tcturn_ModelManager_runModelSync(JNIEnv *env, jclass type, jstring jmodelName,
                                                   jfloatArray jbuf) {
   ...
   //Todo: softmax is not support on npu, you can run it on cpu
